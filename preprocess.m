...
inputDir = 'E:\FYP\Egg-Based Emotion Recognition\EEg-based-Emotion-Recognition\SEED\SEED_EEG\SEED_RAW_EEG';
...
% Load the .cnt file
cfg = [];
cfg.dataset = fullfile(inputDir, '1_1.cnt');
...
cfg.runica.pca = min(50, length(data.label)-1); %set the number of principal components to retain
%Approach 2
...
save('preprocessed_seed_data.mat', 'data');
